...
<div >
    ...
    <div class="tpl-login">
        <div class="tpl-login-content" >
            <div class="tpl-login-title">为当前设备添加一个子设备</div>
            <span class="tpl-login-content-info">
               		   请选择子设备的类型
              </span>
            <form class="am-form tpl-form-line-form" action="iot-sub-add?uuid=${devUuid}"  method="POST">
                <span th:text="${addInfo}" style="color: red">${addInfo}</span>
                <input type="hidden" th:name="${_csrf.parameterName}" th:value="${_csrf.token}"/>
               		<div class="am-form-group">
                    <input type="text" name="iotname" class="tpl-form-input" id="devId" placeholder="设备名称">
                	</div>  
					<div class="am-form-group">
